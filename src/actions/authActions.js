...
export const loadUser = () => (dispatch, getState) => {
    ...
    axios.get(`https://todoapp-hub.herokuapp.com/users/user/${user_id}`, tokenConfig(getState))
        .then(res => dispatch({
            type: USER_LOADED,
            payload: res.data
        }))
...
export const register = ({username, password}) => (dispatch) => {
    ...
    axios.post('https://todoapp-hub.herokuapp.com/users/register/', body, config)
        .then(res => dispatch({
...
export const login = ({username, password}) => (dispatch) => {
    ...
    const body = JSON.stringify({username, password})
    axios.post('https://todoapp-hub.herokuapp.com/users/login/', body, config)
        .then(res => {
            try{
                dispatch({
                    type: LOGIN_SUCCESS,
